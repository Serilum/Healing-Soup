...
public class ModNeoForge {
	...
	public static final DeferredItem<Item> MUSHROOM_SOUP_ITEM = ITEMS.register("mushroom_soup", () -> new Item((new Item.Properties()).stacksTo(1).food(SoupFoods.MUSHROOM_SOUP)));
	public static final DeferredItem<Item> CACTUS_SOUP_ITEM = ITEMS.register("cactus_soup", () -> new Item((new Item.Properties()).stacksTo(1).food(SoupFoods.CACTUS_SOUP)));
	public static final DeferredItem<Item> CHOCOLATE_MILK_ITEM = ITEMS.register("chocolate_milk", () -> new Item((new Item.Properties()).stacksTo(1).food(SoupFoods.CHOCOLATE_MILK)));
