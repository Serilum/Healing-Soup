...
public class ModCommon {
	...
	public static void registerAssets(Object modEventBusObject) {
		Services.REGISTERITEM.registerItem(modEventBusObject, ResourceLocation.fromNamespaceAndPath(Reference.MOD_ID, "mushroom_soup"), () -> new Item((new Item.Properties()).stacksTo(1).food(SoupFoods.MUSHROOM_SOUP)), CreativeModeTabFunctions.getCreativeModeTabResourceKey("food_and_drinks"));
		Services.REGISTERITEM.registerItem(modEventBusObject, ResourceLocation.fromNamespaceAndPath(Reference.MOD_ID, "cactus_soup"), () -> new Item((new Item.Properties()).stacksTo(1).food(SoupFoods.CACTUS_SOUP)), CreativeModeTabFunctions.getCreativeModeTabResourceKey("food_and_drinks"));
		Services.REGISTERITEM.registerItem(modEventBusObject, ResourceLocation.fromNamespaceAndPath(Reference.MOD_ID, "chocolate_milk"), () -> new Item((new Item.Properties()).stacksTo(1).food(SoupFoods.CHOCOLATE_MILK)), CreativeModeTabFunctions.getCreativeModeTabResourceKey("food_and_drinks"), true);
	}
